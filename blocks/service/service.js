/*
 * service Block (EDS compatible)
 * - Converts simple authored rows into structured service tiles
 * - Produces:
 *   <div class="service row">
 *     <div class="service-tile">...</div>
 *   </div>
 */
...
export default function decorate(block) {
  ...
  rows.forEach((row) => {
    ...
    serviceRow.appendChild(tile);
  });

  // Replace authored markup with final structure
  block.innerHTML = '';
  block.appendChild(serviceRow);
}